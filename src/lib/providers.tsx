...
const en: Dict = {
  ...
  'sched.overrideHint':   '🔒 This week is confirmed — employees can no longer edit, but you (admin) can still override any cell here. Changes save instantly.',
  'sched.swap':           'Swap',
  'sched.swapDone':       'Done',
  'sched.swapHint':       '🔀 Swap mode — click two cells to swap their shifts.',
  ...
  'join.password':   'Password (min 6 chars)',
  'join.continueEmail': 'Continue with email',
  'join.joinNow':    'Join now',
  'join.deviceNote': 'Quickest — you stay signed in on this device.',
  'join.orAccount':  'or sign in with an account (access from any device)',
  'join.emailExists':'This email already has an account — enter its correct password (or ask your supervisor to reset it).',
  'join.haveAccount':'Already registered? Enter the same email + password to sign in.',
  ...
  'landing.goApp':          'Go to your dashboard',
  'landing.goAppAgent':     'Open my schedule',

  'landing.badge':          'Built for teams that run around the clock',
  'landing.title1':         'Shift scheduling,',
  'landing.title2':         'finally effortless',
  'landing.subtitle':       'Schedoo turns messy spreadsheets into a living schedule. Your team registers their own shifts, managers approve in one click, and coverage is guaranteed — for any team, any sector, in Arabic or English.',
  'landing.ctaPrimary':     'Get started free',
  'landing.ctaSecondary':   'Sign in',
  'landing.trust':          'No credit card · Set up in minutes · Works on every device',

  'landing.mock.title':     'This week · Call Center',
  'landing.mock.covered':   'Fully covered',
  'landing.mock.morning':   'Morning',
  'landing.mock.evening':   'Evening',
  'landing.mock.night':     'Night',
  'landing.mock.off':       'Off',

  'landing.featuresKicker': 'Everything you need',
  'landing.featuresTitle':  'A framework that bends to how you actually work',
  'landing.featuresSub':    'Not a rigid template — an empty canvas you shape around your teams, shifts and rules.',

  'landing.f1.t':           'Self-serve registration',
  'landing.f1.d':           'Send one invite link. Your team registers their own shifts and time off — no more chasing people over WhatsApp.',
  'landing.f2.t':           'Coverage you can trust',
  'landing.f2.d':           'Set how many people each shift needs. Schedoo flags gaps and overstaffing instantly, so no slot is ever left uncovered.',
  'landing.f3.t':           'Multi-team, multi-account',
  'landing.f3.d':           'Organize by accounts, teams and roles. Owners, admins and team managers each see exactly what they should.',
  'landing.f4.t':           'Full control, always',
  'landing.f4.d':           'Edit any schedule after it is confirmed, swap work and off days, add or reduce leave. The tool bends to you.',
  'landing.f5.t':           'Arabic & English, dark mode',
  'landing.f5.d':           'Fully bilingual with right-to-left support and a beautiful dark theme, built in from day one.',
  'landing.f6.t':           'Reports & exports',
  'landing.f6.d':           'Export schedules to Excel and PDF, review coverage reports, and share polished plans with your whole team.',

  'landing.howKicker':      'How it works',
  'landing.howTitle':       'From chaos to clarity in three steps',
  'landing.s1.t':           'Create your company',
  'landing.s1.d':           'Set up accounts, teams, shifts and coverage rules — a blank framework you shape.',
  'landing.s2.t':           'Invite your team',
  'landing.s2.d':           'Share one link. Everyone registers their own shifts and availability.',
  'landing.s3.t':           'Approve & publish',
  'landing.s3.d':           'Confirm the schedule, handle swaps, and everyone gets their plan instantly.',

  'landing.stat1n':         '29+',
  'landing.stat1l':         'people on one live schedule',
  'landing.stat2n':         '2',
  'landing.stat2l':         'languages, full RTL support',
  'landing.stat3n':         '1',
  'landing.stat3l':         'link to onboard your whole team',
  'landing.stat4n':         '∞',
  'landing.stat4l':         'teams, accounts & shifts',
...
const ar: Dict = {
  ...
  'sched.overrideHint':   '🔒 الأسبوع مؤكّد — الموظفين مش قادرين يعدّلوا، بس إنت (الأدمن) تقدر تعدّل أي خانة هنا. التغيير بيتحفظ فوراً.',
  'sched.swap':           'تبديل',
  'sched.swapDone':       'تم',
  'sched.swapHint':       '🔀 وضع التبديل — اضغط خانتين لتبديل شيفتاتهم.',
  ...
  'join.password':   'كلمة المرور (6 حروف على الأقل)',
  'join.continueEmail': 'الدخول بالإيميل',
  'join.joinNow':    'انضم دلوقتي',
  'join.deviceNote': 'الأسرع — هتفضل مسجّل على الجهاز ده.',
  'join.orAccount':  'أو سجّل بحساب (عشان تدخل من أي جهاز)',
  'join.emailExists':'الإيميل ده عنده حساب بالفعل — اكتب الباسورد الصح (أو كلّم المشرف يعيده لك).',
  'join.haveAccount':'مسجّل قبل كده؟ اكتب نفس الإيميل والباسورد عشان تدخل.',
  ...
  'landing.goApp':          'روح للوحة التحكم',
  'landing.goAppAgent':     'افتح جدولي',

  'landing.badge':          'اتعمل مخصوص للفرق اللي بتشتغل على مدار الساعة',
  'landing.title1':         'جدولة الشيفتات،',
  'landing.title2':         'أخيراً من غير وجع دماغ',
  'landing.subtitle':       'سكيدوو بيحوّل الإكسل شيت المبعثر لجدول حيّ. فريقك بيسجّل شيفتاته وإجازاته بنفسه، والمدير بيوافق بضغطة واحدة، والتغطية مضمونة — لأي فريق، أي قطاع، بالعربي أو الإنجليزي.',
  'landing.ctaPrimary':     'ابدأ مجاناً',
  'landing.ctaSecondary':   'تسجيل الدخول',
  'landing.trust':          'من غير بطاقة ائتمان · تجهيز في دقايق · بيشتغل على أي جهاز',

  'landing.mock.title':     'الأسبوع ده · الكول سنتر',
  'landing.mock.covered':   'مغطّى بالكامل',
  'landing.mock.morning':   'صباحي',
  'landing.mock.evening':   'مسائي',
  'landing.mock.night':     'ليلي',
  'landing.mock.off':       'أجازة',

  'landing.featuresKicker': 'كل اللي محتاجه',
  'landing.featuresTitle':  'إطار بيتظبّط على طريقة شغلك الفعلية',
  'landing.featuresSub':    'مش قالب جامد — كانفاس فاضي بتشكّله حوالين فرقك وشيفتاتك وقواعدك.',

  'landing.f1.t':           'تسجيل ذاتي للموظفين',
  'landing.f1.d':           'ابعت لينك دعوة واحد. فريقك بيسجّل شيفتاته وإجازاته بنفسه — بلاش جري ورا الناس على الواتساب.',
  'landing.f2.t':           'تغطية تقدر تعتمد عليها',
  'landing.f2.d':           'حدّد كل شيفت محتاج كام واحد. سكيدوو بينبّهك على النقص والزيادة على طول، فمفيش سلوت بيفضل من غير تغطية.',
  'landing.f3.t':           'فرق وأكونتات متعددة',
  'landing.f3.d':           'نظّم بالأكونتات والفرق والأدوار. المالك والأدمن ومدير الفريق — كل واحد بيشوف اللي يخصّه بالظبط.',
  'landing.f4.t':           'تحكّم كامل، دايماً',
  'landing.f4.d':           'عدّل أي جدول بعد ما يتأكّد، بدّل بين أيام الشغل والراحة، زوّد أو قلّل الإجازات. الأداة بتتظبّط عليك.',
  'landing.f5.t':           'عربي وإنجليزي، ووضع ليلي',
  'landing.f5.d':           'ثنائي اللغة بالكامل مع دعم الكتابة من اليمين، وثيم داكن جميل — من أول يوم.',
  'landing.f6.t':           'تقارير وتصدير',
  'landing.f6.d':           'صدّر الجداول لإكسل وPDF، راجع تقارير التغطية، وشارك خطط مرتّبة مع كل فريقك.',

  'landing.howKicker':      'إزاي بيشتغل',
  'landing.howTitle':       'من الفوضى للوضوح في ٣ خطوات',
  'landing.s1.t':           'اعمل شركتك',
  'landing.s1.d':           'جهّز الأكونتات والفرق والشيفتات وقواعد التغطية — إطار فاضي بتشكّله انت.',
  'landing.s2.t':           'ادعُ فريقك',
  'landing.s2.d':           'شارك لينك واحد. كل واحد بيسجّل شيفتاته وأوقات توافره بنفسه.',
  'landing.s3.t':           'وافق وانشر',
  'landing.s3.d':           'أكّد الجدول، اتعامل مع التبديلات، وكل واحد بيوصله خطته في الحال.',

  'landing.stat1n':         '+٢٩',
  'landing.stat1l':         'فرد على جدول حيّ واحد',
  'landing.stat2n':         '٢',
  'landing.stat2l':         'لغة، بدعم كامل لليمين',
  'landing.stat3n':         '١',
  'landing.stat3l':         'لينك يضم كل فريقك',
  'landing.stat4n':         '∞',
  'landing.stat4l':         'فرق وأكونتات وشيفتات',
