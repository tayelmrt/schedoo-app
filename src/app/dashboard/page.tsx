...
export default function DashboardPage() {
  ...
  // Teams the user manages that aren't under any account shown here (e.g. team managers).
  const shownAccountIds = new Set(accounts.map(a => a.id))
  const orphanTeams = teams.filter(tm => !tm.account_id || !shownAccountIds.has(tm.account_id))
  const isEmpty = accounts.length === 0 && orphanTeams.length === 0
    ...
    <div className="p-8">
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          {/* Teams the user manages directly (e.g. team managers without account access) */}
